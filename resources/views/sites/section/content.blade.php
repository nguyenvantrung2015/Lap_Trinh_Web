                ...
                <div class="fh5co-grid">
                    ...
                    <div class="fh5co-v-half">
                        <div class="fh5co-h-row-2 to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url(../img/f2.jpg)"></div>
                        ...
                        <div class="fh5co-h-row-2 fh5co-reversed to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url(../img/f8.jpg)"></div>
                    ...
                    <div class="fh5co-v-half">
                        <div class="fh5co-h-row-2 fh5co-reversed to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url(../img/f7.jpg)"></div>
                            <div class="fh5co-v-col-2 fh5co-text arrow-right">
                                <h2>Organic Egg</h2>
                        ...
                        <div class="fh5co-h-row-2 to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url(../img/f6.jpg)"></div>
                            <div class="fh5co-v-col-2 fh5co-text arrow-left">
                    ...
                    <div class="fh5co-food-menu to-animate-2">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="fh5co-food-desc">
                                    <figure>
                                        <img src="../img/f9.jpg" class="img-responsive" alt="">
                                    </figure>
                                    <div>
                                        <h3>Soft Drinks</h3>
                                        <p>Far far away, behind the word mountains.</p>
                    ...
                    <div class="fh5co-food-menu to-animate-2">
                        ...
                        <ul>
                            <li>
                                <div class="fh5co-food-desc">
                                    <figure>
                                        <img src="../img/f4.jpg" class="img-responsive">
                                    </figure>
                                    <div>
                                        <h3>Beef Steak</h3>
                                        <p>Far far away, behind the word mountains.</p>
