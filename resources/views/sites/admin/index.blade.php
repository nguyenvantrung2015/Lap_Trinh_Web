...
<!-- Font Awesome -->
{{--{{ Html::style('bower/font-awesome/css/font-awesome.min.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/font-awesome/css/font-awesome.min.css" rel="stylesheet">
<!-- Ionicons -->
{{--{{ Html::style('bower/Ionicons/css/ionicons.min.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/Ionicons/css/ionicons.min.css" rel="stylesheet">
<!-- Theme style -->
{{--{{ Html::style('dist/css/AdminLTE.min.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/bootstrap/dist/css/AdminLTE.min.css" rel="stylesheet">
{{--{{ Html::style('bower/Ionicons/css/ionicons.min.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/Ionicons/css/ionicons.min.css" rel="stylesheet">
<!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
{{--{{ Html::style('dist/css/skins/_all-skins.min.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/bootstrap/dist/css/skins/_all-skins.min.css" rel="stylesheet">
<!-- Morris chart -->
{{--{{ Html::style('bower/morris.js/morris.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/morris.js/morris.css" rel="stylesheet">
<!-- jvectormap -->
{{--{{ Html::style('bower/jvectormap/jquery-jvectormap.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/jvectormap/jquery-jvectormap.css" rel="stylesheet">
<!-- Date Picker -->
{{--{{ Html::style('bower/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" rel="stylesheet">
<!-- Daterange picker -->
{{--{{ Html::style('bower/bootstrap-daterangepicker/daterangepicker.css', ['rel' => 'stylesheet']) }}--}}
    <link href="bower/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
<!-- bootstrap wysihtml5 - text editor -->
{{--{{ Html::style('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css', ['rel' => 'stylesheet']) }}--}}
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="bower/bootstrap/dist/img/user2-160x160.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
...
<!-- AdminLTE App -->
<script src="bower/bootstrap/dist/js/adminlte.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="bower/bootstrap/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="bower/bootstrap/dist/js/demo.js"></script>
</body>
</html>
