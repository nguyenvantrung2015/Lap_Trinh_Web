...
{{ HTML::style('/css/users/profile.css', ['rel' => 'stylesheet', 'type' => 'text/css']) }}
...
<!-- jQuery library -->
{{ HTML::script('/bower/jquery/dist/jquery.min.js', ['type' => 'text/javascript']) }}

<!-- Latest compiled JavaScript -->
{{ HTML::script('/bower/bootstrap/dist/js/bootstrap.js', ['type' => 'text/javascript']) }}
