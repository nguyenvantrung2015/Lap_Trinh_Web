...
<head>
    ...
    {{ HTML::style('bower/admin-lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                @else
                                <img src="http://giaitri.danongonline.com.vn/wp-content/uploads/2016/04/20160417_5712e215dadc4.jpg"
                                class="user-image" alt="User Image">
                                @endif
                                <span class="hidden-xs">Đông</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="header">Bảng làm việc</li>
                    <li class="active treeview">
                        <a href="#">
                            <i class="fa fa-dashboard"></i> <span>bảng 1</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="active"><a href="{{route('admin_index')}}"><i class="fa fa-circle-o"></i> bảng 1
                            </a></li>
                            <li><a href="{{route('admin_index2')}}"><i class="fa fa-circle-o"></i> bảng 2</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="pages/UI/general.html"><i class="fa fa-circle-o"></i>giới tính </a></li>
                            <li><a href="pages/UI/icons.html"><i class="fa fa-circle-o"></i> Info</a></li>
                            <li><a href="pages/UI/buttons.html"><i class="fa fa-circle-o"></i> tuổi</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-edit"></i> <span>Đồ uống </span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> có ga</a></li>
                            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> không ga</a>
                            </li>
                            <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i>bình thường</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-table"></i> <span>Đồ ăn</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i>đồ ăn nhanh</a></li>
                            <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i> đồ đắt tiền</a></li>
                        </ul>
                    </li>
                    <li>
                            ...
                            <section class="col-lg-5 connectedSortable">
                                ...
                                <div class="box box-solid bg-green-gradient">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">Bảng ngày Action</h3>
                                        <!-- tools box -->
                                        <div class="pull-right box-tools">
                                    ...
                                    <div class="box-footer text-black">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!-- Progress bars -->
                                                <div class="clearfix">
                                                    <span class="pull-left">thức ăn nhanh</span>
                                                ...
                                                <div class="clearfix">
                                                    <span class="pull-left">đồ uống</span>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="clearfix">
                                                    <span class="pull-left">thức ăn khô</span>
                                                ...
                                                <div class="clearfix">
                                                    <span class="pull-left">thức ăn </span>
...
<script src="bower/admin-lte/dist/js/pages/dashboard.js"></script>
