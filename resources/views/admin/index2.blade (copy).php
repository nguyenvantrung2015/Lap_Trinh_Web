...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('bower/admin-lte/dist/css/skins/_all-skins.min.css') }}">
    <link rel="stylesheet"
...
<script src="{{ asset('bower/jquery-sparkline/dist/jquery.sparkline.min.js') }}"></script>
<script src="{{ asset('bower/admin-lte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ asset('bower/admin-lte/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('bower/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
<script src="{{ asset('bower/Chart.js/Chart.js') }}"></script>
<script src="{{ asset('bower/admin-lte/dist/js/pages/dashboard2.js') }}"></script>
<script src="{{ asset('bower/admin-lte/dist/js/demo.js') }}"></script>
</body>
</html>
